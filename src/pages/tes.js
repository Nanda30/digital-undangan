  ...
  return (
    <section className="relative flex justify-center items-center py-10 px-6 bg-gray-100">
      ...
      <div className="relative bg-white/90 shadow-xl rounded-xl p-6 w-full max-w-lg">
        {/* Header */}
        <h2 className="text-center text-2xl font-serif font-bold text-[#715b40]">
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          <input
            ...
            className="w-full p-3 border rounded-md focus:ring-2 focus:ring-[#715b40] focus:outline-none"
          />
          <textarea
            rows={3}
        ...
        <div className="mt-6 space-y-4">
          {displayedUcapan.map((ucapan, index) => (
            <div key={index} className="bg-white p-4 rounded-lg shadow-md border">
              <h3 className="font-semibold text-lg text-[#715b40]">{ucapan.nama}</h3>
